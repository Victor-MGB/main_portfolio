      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-7">
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          <li class="mb-10" data-aos="zoom-in">
            ...
            <span class="block pt-1 pb-3  text-sm font-normal leading-none  text-gray-500">
          ...
          <li class="mb-10" data-aos="zoom-out" data-aos-delay="700">
            ...
            <p class="text-base font-normal text-gray-400">
              ...
              built web applications with the Express framework, build a car and home api for my projects and  some
              mini-projects 
            </p>
            <a
              href="_"
          ...
          <li data-aos="zoom-in" data-aos-offset={"-15"} data-aos-delay="1300">
            ...
            <time class="block mb-2 text-sm font-normal leading-none text-gray-500">
            still under construction with team
            </time>
            <p class="text-base font-normal text-gray-400">
              Learns how to style your site quickly with Tailwind. I also learn
              how to add logic to your CSS styles and extend them with JavaScript code.
              Later, I also built a Car commerce and Real estate website and other applications to
        ...
        <div className="flex flex-col text-center" data-aos="slide-up">
          ...
          <div className="ml-16 flex flex-col gap-8 mt-6">
            ...
            <BarGraph name={"Node Js"} percent={80} />
            <BarGraph name={"HTML/CSS"} percent={85} />
            <BarGraph name={"MongoDb"} percent={65} />
            <BarGraph name={"Tailwind / PrelineUi"} percent={60} />
          </div>
